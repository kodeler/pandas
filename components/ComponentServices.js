  ...
  return (
    <div className="py-8" id="howWeWorkComponent">
      <div className="container mx-auto px-4">
        <h2 className="mb-6 text-2xl sm:text-4xl font-bold mb-4 bg-gradient-to-r bg-gradient-to-r from-[#22C62E] to-[#D8D8D8] text-transparent bg-clip-text text-center" data-aos="fade-up">
          How We Work?
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="p-4 border pr-4 md:pr-9 pl-4 md:pl-5 py-8 md:py-10 rounded-lg shadow-md" data-aos="fade-right">
            ...
            <h3 className="text-center text-lg md:text-xl font-bold mb-2 md:mb-4 text-[#22C62E]">Centralized Data Platform</h3>

    ...
    <div className="bg-black py-8 md:py-16" id="howWeWorkComponent">
      <div className="container mx-auto px-4">
        <div className="text-center">
          <h2 className="text-base text-[#FFC857] font-semibold tracking-wide uppercase">Our Services</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8 mt-8">
          <div className="p-4 rounded-lg shadow-md bg-gray-900" data-aos="fade-right">
            ...
            <h3 className="text-center text-lg md:text-xl font-bold mb-2 md:mb-4 text-[#FFC857]">Seamless integration with your data ecosystem</h3>
          ...
          <div className="p-4 rounded-lg shadow-md bg-gray-900" data-aos="fade-left">
            ...
            <h3 className="text-center text-lg md:text-xl font-bold mb-2 md:mb-4 text-[#FFC857]">Natural Language Query</h3>
            <p className="text-white text-sm md:text-base">
          ...
          <div className="p-4 rounded-lg shadow-md bg-gray-900" data-aos="fade-right">
            ...
            <h3 className="text-center text-lg md:text-xl font-bold mb-2 md:mb-4 text-[#FFC857]">Advanced Analytics</h3>
            <p className="text-white text-sm md:text-base">
          ...
          <div className="p-4 rounded-lg shadow-md bg-gray-900" data-aos="fade-left">
            ...
            <h3 className="text-center text-lg md:text-xl font-bold mb-2 md:mb-4 text-[#FFC857]">Visualizations and Reports</h3>
            <p className="text-white text-sm md:text-base">
